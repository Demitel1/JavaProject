...
public class Task60 {
    public static void main(String[] args) {
        ...
        System.out.println("Добро пожаловать в интернет-магазин!\n" +
                "Выберите желаемый ноутбук по важным, для вас, критериям.\n");
        boolean filter = true;
        while (filter) {
            System.out.println("Введите критерий поиска: \n" +
                    "ОЗУ, введите - 1\n" +
                    "Объем жесткого диска, введите - 2\n" +
                    "Операционной системе, введите - 3\n" +
                    "Цветовой дизайн, введите - 4\n" +
                    "Модель, введите - 5\n" +
                    "Выход из поиска, введите - 0");
    ...
    public static void filterRAM(HashSet<Notebook> notebooks, Scanner scanner) {
        ...
        System.out.println();
        System.out.println("Ноутбуки отфильтрованы по категории 'оперативная память': "
    ...
    public static void FilterHardDisk(HashSet<Notebook> notebooks, Scanner scanner) {
        ...
        System.out.println();
        System.out.println("Ноутбуки отфильтрованы по категории 'объемом жесткого диска': "
    ...
    public static void filterOS(HashSet<Notebook> notebooks, Scanner scanner) {
        ...
        System.out.println();
        System.out.println("Ноутбуки отфильтрованы по категории 'операционная система': "
    ...
    public static void filterColor(HashSet<Notebook> notebooks, Scanner scanner) {
        ...
        System.out.println();
        System.out.println("Ноутбуки отфильтрованы по категории 'цветовой дизайн': "
